...
wget -O android_dependencies/com.google.firebase.firebase-dynamic-links-ktx-$DynamicLinksVersion.ane https://github.com/tuarua/Android-ANE-Dependencies/blob/master/anes/firebase/com.google.firebase.firebase-dynamic-links-ktx-$DynamicLinksVersion.ane?raw=true
