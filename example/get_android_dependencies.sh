...
wget -O android_dependencies/com.google.android.gms.play-services-base-15.0.1.ane https://github.com/tuarua/Android-ANE-Dependencies/blob/master/anes/play-services/com.google.android.gms.play-services-base-15.0.1.ane?raw=true
wget -O android_dependencies/com.google.firebase.firebase-analytics-16.0.0.ane https://github.com/tuarua/Android-ANE-Dependencies/blob/master/anes/firebase/com.google.firebase.firebase-analytics-16.0.0.ane?raw=true
...
wget -O android_dependencies/com.google.firebase.firebase-config-16.0.0.ane https://github.com/tuarua/Android-ANE-Dependencies/blob/master/anes/firebase/com.google.firebase.firebase-config-16.0.0.ane?raw=true
wget -O android_dependencies/com.google.firebase.firebase-dynamic-links-16.0.0.ane https://github.com/tuarua/Android-ANE-Dependencies/blob/master/anes/firebase/com.google.firebase.firebase-dynamic-links-16.0.0.ane?raw=true
...
wget -O android_dependencies/com.google.firebase.firebase-iid-16.0.0.ane https://github.com/tuarua/Android-ANE-Dependencies/blob/master/anes/firebase/com.google.firebase.firebase-iid-16.0.0.ane?raw=true
