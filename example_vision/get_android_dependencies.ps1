...
Invoke-WebRequest -OutFile "$currentDir\android_dependencies\com.google.firebase.com.google.firebase.firebase-ml-model-interpreter-$FirebaseVersion.ane" -Uri https://github.com/tuarua/Android-ANE-Dependencies/blob/master/anes/firebase/com.google.firebase.firebase-ml-model-interpreter-$FirebaseVersion.ane?raw=true
