...
import com.tuarua.firebase.modelinterpreter.extensions.*
...
class KotlinController : FreKotlinMainController {
    ...
    fun registerCloudModel(ctx: FREContext, argv: FREArgv): FREObject? {
        ...
        val modelSource = FirebaseCloudModelSource(argv[0]) ?: return null
    ...
    fun registerLocalModel(ctx: FREContext, argv: FREArgv): FREObject? {
        argv.takeIf { argv.size > 0 } ?: return FreArgException("init")
        val modelSource = FirebaseLocalModelSource(argv[0]) ?: return null
