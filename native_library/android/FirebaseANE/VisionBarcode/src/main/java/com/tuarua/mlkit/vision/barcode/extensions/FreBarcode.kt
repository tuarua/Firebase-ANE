...
fun Barcode.toFREObject(): FREObject? {
    val ret = FREObject("com.tuarua.mlkit.vision.barcode.Barcode")
...
fun List<Barcode>.toFREObject(): FREArray? {
    return FREArray("com.tuarua.mlkit.vision.barcode.Barcode",
