...
public class AuthANEContext extends FreKotlinContext implements TRActivityResultCallback, TRStateChangeCallback {
    private AndroidActivityWrapper aaw;
    private FreKotlinMainController controller;

    AuthANEContext(String name, FreKotlinMainController controller, String[] functions) {
