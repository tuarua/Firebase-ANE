...
public class RemoteConfigANEContext extends FreKotlinContext implements TRActivityResultCallback, TRStateChangeCallback {
    private AndroidActivityWrapper aaw;
    private FreKotlinMainController controller;
    RemoteConfigANEContext(String name, FreKotlinMainController controller, String[] functions) {
