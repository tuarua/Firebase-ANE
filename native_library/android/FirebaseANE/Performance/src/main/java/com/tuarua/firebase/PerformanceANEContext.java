...
public class PerformanceANEContext extends FreKotlinContext implements TRActivityResultCallback, TRStateChangeCallback {
    private AndroidActivityWrapper aaw;
    private FreKotlinMainController controller;

    PerformanceANEContext(String name, FreKotlinMainController controller, String[] functions) {
