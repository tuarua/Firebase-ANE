...
fun Text.TextBlock.toFREObject(): FREObject? {
    val ret = FREObject("com.tuarua.mlkit.vision.text.TextBlock")
    ret["lines"] = lines
...
fun List<Text.TextBlock>.toFREObject(): FREArray? {
    return FREArray("com.tuarua.mlkit.vision.text.TextBlock",
            size, true, this.map { it.toFREObject() })
}

operator fun FREObject?.set(name: String, value: List<Text.TextBlock>) {
    val rv = this ?: return
