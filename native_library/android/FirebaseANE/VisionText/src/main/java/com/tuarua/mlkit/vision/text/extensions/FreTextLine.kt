...
fun Text.Line.toFREObject(): FREObject? {
    val ret = FREObject("com.tuarua.mlkit.vision.text.TextLine")
...
fun List<Text.Line>.toFREObject(): FREArray? {
    return FREArray("com.tuarua.mlkit.vision.text.TextLine",
            size, true, this.map { it.toFREObject() })
}

operator fun FREObject?.set(name: String, value: List<Text.Line>) {
    val rv = this ?: return
