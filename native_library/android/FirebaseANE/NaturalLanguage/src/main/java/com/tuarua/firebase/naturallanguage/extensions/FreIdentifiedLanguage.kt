...
package com.tuarua.firebase.naturallanguage.extensions
...
fun IdentifiedLanguage.toFREObject(): FREObject? {
    val ret = FREObject("com.tuarua.firebase.naturalLanguage.IdentifiedLanguage")
...
fun List<IdentifiedLanguage>.toFREArray(): FREArray? {
    val ret = FREArray("com.tuarua.firebase.naturalLanguage.IdentifiedLanguage", size, true)
            ?: return null
