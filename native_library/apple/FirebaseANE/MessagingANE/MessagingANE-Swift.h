...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MessagingANE_LIB",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC16MessagingANE_LIB12MessageEvent")
...
SWIFT_CLASS("_TtC16MessagingANE_LIB15SwiftController")
...
@interface SwiftController (SWIFT_EXTENSION(MessagingANE_LIB)) <FIRMessagingDelegate>
...
@interface SwiftController (SWIFT_EXTENSION(MessagingANE_LIB)) <UNUserNotificationCenterDelegate>
...
@interface SwiftController (SWIFT_EXTENSION(MessagingANE_LIB))
