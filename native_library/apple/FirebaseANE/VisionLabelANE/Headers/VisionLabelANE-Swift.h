...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VisionLabelANE_LIB",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC18VisionLabelANE_LIB10LabelEvent")
@interface LabelEvent : NSObject
...
SWIFT_CLASS("_TtC18VisionLabelANE_LIB15SwiftController")
@interface SwiftController : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface SwiftController (SWIFT_EXTENSION(VisionLabelANE_LIB))
