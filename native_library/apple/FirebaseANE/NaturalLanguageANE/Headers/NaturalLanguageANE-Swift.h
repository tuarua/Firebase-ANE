...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NaturalLanguageANE_LIB",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC22NaturalLanguageANE_LIB13LanguageEvent")
@interface LanguageEvent : NSObject
...
SWIFT_CLASS("_TtC22NaturalLanguageANE_LIB15SwiftController")
@interface SwiftController : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface SwiftController (SWIFT_EXTENSION(NaturalLanguageANE_LIB))
