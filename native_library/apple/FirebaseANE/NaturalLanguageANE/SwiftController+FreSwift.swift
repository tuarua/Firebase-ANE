...
extension SwiftController: FreSwiftMainController {
    @objc public func getFunctions(prefix: String) -> [String] {
        ...
        functionsToSet["\(prefix)identifyLanguage"] = identifyLanguage
        functionsToSet["\(prefix)identifyPossibleLanguages"] = identifyPossibleLanguages
        functionsToSet["\(prefix)getResults"] = getResults
        functionsToSet["\(prefix)getResultsMulti"] = getResultsMulti
