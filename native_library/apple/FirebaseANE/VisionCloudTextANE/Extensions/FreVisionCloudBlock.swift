...
public extension VisionCloudBlock {
    func toFREObject() -> FREObject? {
        guard let fre = try? FREObject(className: "com.tuarua.firebase.vision.CloudBlock"),
            var ret = fre
            else { return nil }
...
public extension Array where Element == VisionCloudBlock {
    func toFREObject() -> FREObject? {
        guard let ret = try? FREArray(className: "com.tuarua.firebase.vision.CloudBlock",
