...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DynamicLinksANE_LIB",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC19DynamicLinksANE_LIB16DynamicLinkEvent")
@interface DynamicLinkEvent : NSObject
...
SWIFT_CLASS("_TtC19DynamicLinksANE_LIB15SwiftController")
...
@interface SwiftController (SWIFT_EXTENSION(DynamicLinksANE_LIB))
