...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AnalyticsANE_LIB",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC16AnalyticsANE_LIB15SwiftController")
...
@interface SwiftController (SWIFT_EXTENSION(AnalyticsANE_LIB))
