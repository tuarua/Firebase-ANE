...
#define FRE_OBJC_BRIDGE TRFIRST_FlashRuntimeExtensionsBridge // use unique prefix throughout to prevent clashes with other ANEs
...
@implementation StorageANE_LIB
    SWIFT_DECL(TRFIRST) // use unique prefix throughout to prevent clashes with other ANEs
