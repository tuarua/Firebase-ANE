...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VisionFaceANE_LIB",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC17VisionFaceANE_LIB9FaceEvent")
@interface FaceEvent : NSObject
...
SWIFT_CLASS("_TtC17VisionFaceANE_LIB15SwiftController")
@interface SwiftController : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface SwiftController (SWIFT_EXTENSION(VisionFaceANE_LIB))
