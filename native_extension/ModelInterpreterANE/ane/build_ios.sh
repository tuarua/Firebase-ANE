...
PROJECTNAME=ModelInterpreterANE
libSuffix="_LIB"
...
cp -R -L "$pathtome/../../../firebase_frameworks/simulator/FirebaseMLModelInterpreter.framework" "$pathtome/platforms/ios/simulator/Frameworks"
cp -R -L "$pathtome/../../../firebase_frameworks/device/FirebaseMLModelInterpreter.framework" "$pathtome/platforms/ios/device/Frameworks"

cp -R -L "$pathtome/../../../firebase_frameworks/simulator/tensorflow_lite.framework" "$pathtome/platforms/ios/simulator/Frameworks"
