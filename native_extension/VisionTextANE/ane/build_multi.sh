...
cp -R -L "$pathtome/../../../firebase_frameworks/simulator/FirebaseMLVisionTextModel.framework" "$pathtome/platforms/ios/simulator/Frameworks"
cp -R -L "$pathtome/../../../firebase_frameworks/device/FirebaseMLVisionTextModel.framework" "$pathtome/platforms/ios/device/Frameworks"

cp -R -L "$pathtome/../../../firebase_frameworks/simulator/TextDetector.framework" "$pathtome/platforms/ios/simulator/Frameworks"
