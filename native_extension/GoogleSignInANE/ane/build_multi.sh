...
cp "$pathtome/../../../native_library/android/FirebaseANE/GoogleSignIn/build/outputs/aar/GoogleSignIn-release.aar" "$pathtome/platforms/android/app-release.aar"
...
mv "$pathtome/platforms/android/res" "$pathtome/platforms/android/com.tuarua.google.$PROJECTNAME-res"
...
com.tuarua.google.${PROJECTNAME}-res/. \
...
rm -r "$pathtome/platforms/android/com.tuarua.google.$PROJECTNAME-res"
echo "Finished."
