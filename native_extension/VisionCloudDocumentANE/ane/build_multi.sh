...
PROJECTNAME=VisionCloudDocumentANE
libSuffix="_LIB"
...
cp "$pathtome/../../../native_library/android/FirebaseANE/VisionCloudDocument/build/outputs/aar/VisionCloudDocument-release.aar" "$pathtome/platforms/android/app-release.aar"
