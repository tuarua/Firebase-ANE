...
SET projectName=PerformanceANE
...
copy /Y %pathtome%..\..\..\native_library\android\FirebaseANE\Performance\build\outputs\aar\Performance-release.aar %pathtome%platforms\android\app-release.aar
