...
PROJECTNAME=VisionCloudLabelANE
libSuffix="_LIB"
...
cp "$pathtome/../../../native_library/android/FirebaseANE/VisionCloudLabel/build/outputs/aar/VisionCloudLabel-release.aar" "$pathtome/platforms/android/app-release.aar"
