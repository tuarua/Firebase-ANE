...
SET projectName=FirebaseANE
SET subProjectName=Firebase
...
copy /Y %pathtome%..\..\native_library\android\%projectName%\%subProjectName%\build\outputs\aar\%subProjectName%-release.aar %pathtome%platforms\android\app-release.aar
...
rem ren %pathtome%FirebaseANE.ane FirebaseANE.zip
rem call %SZIP% u %pathtome%FirebaseANE.zip -ir!META-INF\*.xml
rem ren %pathtome%FirebaseANE.zip FirebaseANE.ane
