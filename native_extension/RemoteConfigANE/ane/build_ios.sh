...
if [ ! -d "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphonesimulator/" ]; then
echo "No Simulator build. Build using Xcode"
exit
fi

if [ ! -d "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphoneos/" ]; then
...
cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphonesimulator/lib$PROJECTNAME$libSuffix.a" "$pathtome/platforms/ios/simulator/lib$PROJECTNAME.a"
cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphoneos/lib$PROJECTNAME$libSuffix.a" "$pathtome/platforms/ios/device/lib$PROJECTNAME.a"

cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphonesimulator/$PROJECTNAME$fwSuffix.framework" "$pathtome/platforms/ios/simulator/Frameworks"
cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphoneos/$PROJECTNAME$fwSuffix.framework" "$pathtome/platforms/ios/device/Frameworks"
...
cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphonesimulator/GoogleToolboxForMac/GoogleToolboxForMac.framework" "$pathtome/platforms/ios/simulator/Frameworks"
cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphoneos/GoogleToolboxForMac/GoogleToolboxForMac.framework" "$pathtome/platforms/ios/device/Frameworks"

cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphonesimulator/nanopb/nanopb.framework" "$pathtome/platforms/ios/simulator/Frameworks"
cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphoneos/nanopb/nanopb.framework" "$pathtome/platforms/ios/device/Frameworks"

cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphonesimulator/Protobuf/Protobuf.framework" "$pathtome/platforms/ios/simulator/Frameworks"
cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphoneos/Protobuf/Protobuf.framework" "$pathtome/platforms/ios/device/Frameworks"

cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphonesimulator/SwiftyJSON/SwiftyJSON.framework" "$pathtome/platforms/ios/simulator/Frameworks"
cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphoneos/SwiftyJSON/SwiftyJSON.framework" "$pathtome/platforms/ios/device/Frameworks"


#if [ ! -f "$pathtome/../../../example/ios_dependencies/simulator/Frameworks/GoogleToolboxForMac.framework" ]
#then
cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphonesimulator/GoogleToolboxForMac/GoogleToolboxForMac.framework" "$pathtome/../../../example/ios_dependencies/simulator/Frameworks"
cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphoneos/GoogleToolboxForMac/GoogleToolboxForMac.framework" "$pathtome/../../../example/ios_dependencies/device/Frameworks"
cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphonesimulator/nanopb/nanopb.framework" "$pathtome/../../../example/ios_dependencies/simulator/Frameworks"
cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphoneos/nanopb/nanopb.framework" "$pathtome/../../../example/ios_dependencies/device/Frameworks"
cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphonesimulator/Protobuf/Protobuf.framework" "$pathtome/../../../example/ios_dependencies/simulator/Frameworks"
cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphoneos/Protobuf/Protobuf.framework" "$pathtome/../../../example/ios_dependencies/device/Frameworks"
cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphonesimulator/SwiftyJSON/SwiftyJSON.framework" "$pathtome/../../../example/ios_dependencies/simulator/Frameworks"
cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphoneos/SwiftyJSON/SwiftyJSON.framework" "$pathtome/../../../example/ios_dependencies/device/Frameworks"
#fi
