...
SET projectName=RemoteConfigANE
...
copy /Y %pathtome%..\..\..\native_library\android\FirebaseANE\RemoteConfig\build\outputs\aar\RemoteConfig-release.aar %pathtome%platforms\android\app-release.aar
