...
copy /Y %pathtome%..\..\..\native_library\android\FirebaseANE\Messaging\build\outputs\aar\Messaging-release.aar %pathtome%platforms\android\app-release.aar
