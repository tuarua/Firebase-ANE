...
cp "$pathtome/../../../native_library/android/FirebaseANE/Messaging/build/outputs/aar/Messaging-release.aar" "$pathtome/platforms/android/app-release.aar"
...
cp -R -L "$pathtome/../../../firebase_frameworks/simulator/FirebaseMessaging.framework" "$pathtome/platforms/ios/simulator/Frameworks"
cp -R -L "$pathtome/../../../firebase_frameworks/device/FirebaseMessaging.framework" "$pathtome/platforms/ios/device/Frameworks"
