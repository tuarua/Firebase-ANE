...
public class CameraOverlay {
    ...
    public function addChild(nativeDisplayObject:NativeDisplayObject):void {
        ...
        try {
            MLKitANEContext.context.call("addNativeChild", nativeDisplayObject, _contentScaleFactor);
    ...
    public function removeChild(nativeDisplayObject:NativeDisplayObject):void {
        if (MLKitANEContext.context == null) return;
        try {
            MLKitANEContext.context.call("removeNativeChild", nativeDisplayObject.id);
