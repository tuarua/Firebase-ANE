...
cp "$pathtome/../../../native_library/android/FirebaseANE/MLKit/build/outputs/aar/MLKit-release.aar" "$pathtome/platforms/android/app-release.aar"
...
mv "$pathtome/platforms/android/res" "$pathtome/platforms/android/com.tuarua.mlkit.$PROJECTNAME-res"
...
rm -r "$pathtome/platforms/android/com.tuarua.mlkit.$PROJECTNAME-res"
echo "Finished."
