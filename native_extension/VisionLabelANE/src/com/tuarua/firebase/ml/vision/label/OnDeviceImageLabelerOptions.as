...
[RemoteClass(alias="com.tuarua.firebase.ml.vision.label.OnDeviceImageLabelerOptions")]
/**
 * Options for an image label detector.
 */
public class OnDeviceImageLabelerOptions {
     ...
     * @return com.tuarua.firebase.ml.vision.label.VisionImageLabel detector options.
     */
    public function OnDeviceImageLabelerOptions(confidenceThreshold:Number = 0.5) {
