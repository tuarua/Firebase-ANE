...
[RemoteClass(alias="com.tuarua.mlkit.vision.label.ImageLabelerOptions")]
/**
 * Options for an image label detector.
 */
public class ImageLabelerOptions {
     ...
     */
    public function ImageLabelerOptions(confidenceThreshold:Number = 0.5) {
