...
cp -R -L "$pathtome/../../../firebase_frameworks/simulator/FirebaseMLVisionLabelModel.framework" "$pathtome/platforms/ios/simulator/Frameworks"
cp -R -L "$pathtome/../../../firebase_frameworks/device/FirebaseMLVisionLabelModel.framework" "$pathtome/platforms/ios/device/Frameworks"

cp -R -L "$pathtome/../../../firebase_frameworks/simulator/LabelDetector.framework" "$pathtome/platforms/ios/simulator/Frameworks"
