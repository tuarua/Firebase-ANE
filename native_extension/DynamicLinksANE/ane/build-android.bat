...
SET projectName=DynamicLinksANE
...
copy /Y %pathtome%..\..\..\native_library\android\FirebaseANE\DynamicLinks\build\outputs\aar\DynamicLinks-release.aar %pathtome%platforms\android\app-release.aar
