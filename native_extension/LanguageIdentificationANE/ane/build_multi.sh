...
PROJECTNAME=LanguageIdentificationANE
libSuffix="_LIB"
...
mv "$pathtome/platforms/android/res" "$pathtome/platforms/android/com.tuarua.mlkit.nl.$PROJECTNAME-res"
...
rm -r "$pathtome/platforms/android/com.tuarua.mlkit.nl.$PROJECTNAME-res"
echo "Finished."
