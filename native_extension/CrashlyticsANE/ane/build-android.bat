...
SET projectName=CrashlyticsANE
...
copy /Y %pathtome%..\..\..\native_library\android\FirebaseANE\Crashlytics\build\outputs\aar\Crashlytics-release.aar %pathtome%platforms\android\app-release.aar
