...
cp "$pathtome/../../../native_library/android/FirebaseANE/OneSignal/build/outputs/aar/OneSignal-release.aar" "$pathtome/platforms/android/app-release.aar"
