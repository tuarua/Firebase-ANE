...
cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphonesimulator/GTMSessionFetcher/GTMSessionFetcher.framework" "$pathtome/platforms/ios/simulator/Frameworks"
cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphoneos/GTMSessionFetcher/GTMSessionFetcher.framework" "$pathtome/platforms/ios/device/Frameworks"


#if [ ! -f "$pathtome/../../../example/ios_dependencies/simulator/Frameworks/GTMSessionFetcher.framework" ]
#then
...
cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphonesimulator/GTMSessionFetcher/GTMSessionFetcher.framework" "$pathtome/../../../example/ios_dependencies/simulator/Frameworks"
cp -R -L "$pathtome/../../../native_library/ios/FirebaseANE/Build/Products/Release-iphoneos/GTMSessionFetcher/GTMSessionFetcher.framework" "$pathtome/../../../example/ios_dependencies/device/Frameworks"
#fi
