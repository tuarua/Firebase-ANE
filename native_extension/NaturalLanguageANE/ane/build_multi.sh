...
PROJECTNAME=NaturalLanguageANE
libSuffix="_LIB"
...
cp "$pathtome/../../../native_library/android/FirebaseANE/NaturalLanguage/build/outputs/aar/NaturalLanguage-release.aar" "$pathtome/platforms/android/app-release.aar"
