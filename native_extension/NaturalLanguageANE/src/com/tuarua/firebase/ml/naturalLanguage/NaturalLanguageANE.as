...
public class NaturalLanguageANE extends EventDispatcher {
    private var _languageIdentification:LanguageIdentification;
    //noinspection JSFieldCanBeLocal
    private static var _naturalLanguage:NaturalLanguageANE;
    private static var _isStatsCollectionEnabled:Boolean = true;

    /** @private */
    public function NaturalLanguageANE() {
    ...
    public static function get naturalLanguage():NaturalLanguageANE {
        if (!_naturalLanguage) {
            new NaturalLanguageANE();
        }
