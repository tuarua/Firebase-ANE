...
cp -R -L "$pathtome/../../../firebase_frameworks/simulator/FirebaseMLVisionBarcodeModel.framework" "$pathtome/platforms/ios/simulator/Frameworks"
cp -R -L "$pathtome/../../../firebase_frameworks/device/FirebaseMLVisionBarcodeModel.framework" "$pathtome/platforms/ios/device/Frameworks"

cp -R -L "$pathtome/../../../firebase_frameworks/simulator/BarcodeDetector.framework" "$pathtome/platforms/ios/simulator/Frameworks"
cp -R -L "$pathtome/../../../firebase_frameworks/device/BarcodeDetector.framework" "$pathtome/platforms/ios/device/Frameworks"

echo "Copying Android aars into place"
cp "$pathtome/../../../native_library/android/FirebaseANE/VisionBarcode/build/outputs/aar/VisionBarcode-release.aar" "$pathtome/platforms/android/app-release.aar"
