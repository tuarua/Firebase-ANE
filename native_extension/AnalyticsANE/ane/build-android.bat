...
copy /Y %pathtome%..\..\..\native_library\android\FirebaseANE\Analytics\build\outputs\aar\Analytics-release.aar %pathtome%platforms\android\app-release.aar
